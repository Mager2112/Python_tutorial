#Двоичное дерево поиска - структура данных, вид двоичных деревьев
#Оно выполняет следующие свойства:
#Оба их поддерева - двоичные деревья поиска
#Элементы слева - меньше
